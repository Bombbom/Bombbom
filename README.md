...
| [Network Security: Security Monitoring using Wazuh](https://github.com/Bombbom/Network_Security/blob/main/Security_Monitoring.md) | - | Learn how to set up zero-cost security automation, incident response, file integrity monitoring systems, and cloud security monitoring | Wazuh, Suricata, ... |
